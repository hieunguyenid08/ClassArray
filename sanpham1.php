    ...
    <div class="container grid grid-cols-2 gap-6  ">
        ...
        <div>
            ...
            <div class="flex gap-3 border-b border-gray-200 pb-5 mt-6">
                ...
                <a href="sanpham2.php" class="border border-gray-300 text-gray-600  px-8 py-2 font-medium rounded uppercase flex items-center gap-2 hover:text-primary transition">
