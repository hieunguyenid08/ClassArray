      ...
      <div class="col-span-3">
        <div class="px-4 py-3 shadow flex items-center gap-4">
          <div class="flex-shrink-0">
            <img src="anh.jpg" class="w-14 rounded-full h-14 border border-gray-200 p-1 object-cover" alt="" />
          </div>
          <div class="flex-grow">
        ...
        <div class="mt-6 bg-white shadow rounded p-4 divide-y divide-gray-200 space-y-4 text-gray-600">
          <div class="space-y-1 pl-8">
            <a href="#" class="relative text-red-500 block font-medium capitalize hover:text-pink-800"><span class="absolute -left-8 top-0 text-base">
                <i class="fa fa-address-card"></i>
              </span>
              Mang aount</a>
            <a href="#" class="relative text-primary block font-medium capitalize">
              Info</a>
            <a href="#" class="relative text-primary block font-medium capitalize">
              Masndja</a>
          </div>
        ...
        <div class="flex items-center justify-between gap-6 p-4 border border-gray-200 rounded">
          ...
          <div class="w-1\/2">
            ...
            <p class="text-gray-500 text-sm">
              AVaiadaskjdklasjdlaksjdlk: <span class="text-green-600">adasdas</span>
            </p>
          </div>
          <div class="text-primary text-lg font-semibold">#320.00</div>
          <a href="#" class="px-6 py-2 text-center text-sm text-white bg-purple-500 border border-red-500 rounded hover: btn btn-primary transition uppercase font-medium">ADD TO CARD</a>
